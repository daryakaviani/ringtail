...
This is a pure Golang implementation of Ringtail, a practical two-round threshold signature scheme from LWE. Additionally, it includes detailed pseudocode of hybrids for Theorem 3.1 (see `hybrid.pdf`).
